...
namespace PlanetService.Grpc.Interceptors
{
    /// <summary>
    ...
    public class ValidationInterceptor : Interceptor
    {
        ...
        private static async Task ValidateRequest<TRequest>(
            TRequest request,
        ...
        private static async Task CheckRequestMessage<TRequest>(TRequest request, ServerCallContext callContext)
        ...
        /// <param name="callContext">The call context.</param>
        private static async Task CheckRequestStream<TRequest>(IAsyncStreamReader<TRequest> requestStream,
